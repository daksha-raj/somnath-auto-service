  ...
  const reviews = [
    {
      ...
      location: "Mendarda",
      rating: 5,
      text: "Outstanding service! My Mahindra XUV700 looks absolutely brand new after their complete detailing. The team is highly professional and prices are very reasonable. Highly recommend!",
    },
    {
      name: "Suresh Solanki",
      location: "Chiroda",
