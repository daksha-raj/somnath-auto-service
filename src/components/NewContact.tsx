...
const NewContact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      icon: Clock,
      title: "Working Hours",
      content: "Monday - Saturday: 8:00 AM - 8:00 PM Sunday: 9:00 AM - 6:00 PM",
      // href: "https://maps.google.com/?q=21.3488,70.3036",
    },
  ];
          ...
          >
            <Card className="h-full overflow-hidden border-4 border-border/50 shadow-2xl">
              <CardContent className="p-0 h-full min-h-[700px]">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3716.67640834229!2d70.4475215!3d21.323798999999994!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be2ad789062f407%3A0xf63fdf828a3d5f80!2sSomnath%20Auto%20Service%20Station!5e0!3m2!1sen!2sin!4v1762586563251!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
